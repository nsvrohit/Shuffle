...
var SongPage = /** @class */ (function () {
    function SongPage(navCtrl, navParams, fb, nativePageTransitions) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.fb = fb;
        this.nativePageTransitions = nativePageTransitions;
        this.ratingForm = this.fb.group({
            rating: ['', __WEBPACK_IMPORTED_MODULE_3__angular_forms__["f" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_3__angular_forms__["f" /* Validators */].pattern('[1-5]'), __WEBPACK_IMPORTED_MODULE_3__angular_forms__["f" /* Validators */].required])],
        });
    ...
    SongPage.prototype.rateSong = function () {
        var firestore = __WEBPACK_IMPORTED_MODULE_4_firebase___default.a.firestore();
